(module
 ...
 (data (i32.const 1480) "\01\00\00\00\02\00\00\00:")
 (data (i32.const 1500) ",")
 ...
 (data (i32.const 2100) "\10A\82\00\00\00\00\00\02A")
      ...
      block $~lib/arraybuffer/ArrayBufferView
       block $~lib/string/String
        block $~lib/arraybuffer/ArrayBuffer
         ...
         i32.sub
         i32.load
         br_table $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $assembly/index/Node $~lib/map/Map<~lib/string/String,assembly/index/Node> $~lib/array/Array<assembly/index/Node> $invalid
        end
        return
       end
       return
 ...
 (func $~lib/map/Map<~lib/string/String,assembly/index/Node>#set (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
 ...
 (func $export:assembly/index/match (param $0 i32) (param $1 i32) (result i32)
  ...
  block $folding-inner3
   ...
   i32.sub
   global.set $~lib/memory/__stack_pointer
   block $__inlined_func$assembly/index/match
    block $folding-inner2
     ...
     i32.add
     global.set $~lib/memory/__stack_pointer
     br $__inlined_func$assembly/index/match
    end
    global.get $~lib/memory/__stack_pointer
    i32.const 24
    i32.add
