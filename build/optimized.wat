(module
 ...
 (data (i32.const 1824) "\05\00\00\00 \00\00\00\00\00\00\00 ")
 (data (i32.const 1860) "\02A")
 ...
 (func $~lib/array/Array<assembly/index/Node>#push (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  local.get $0
  local.get $0
 ...
 (func $export:assembly/index/match (param $0 i32) (param $1 i32) (result i32)
  ...
  block $folding-inner0
   ...
   local.get $1
   i32.store offset=4
   block $__inlined_func$assembly/index/match (result i32)
    local.get $2
    i32.const 12
    i32.sub
    global.set $~lib/memory/__stack_pointer
